...
const { createPropostaContratoController } = require('../controllers/PropostaContratoController'); // Ajuste o nome do arquivo se necessário
...
// router.route('/:id').get(getPropostaContratoByIdController);
