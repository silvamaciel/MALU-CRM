...
console.log("FACEBOOK_APP_ID (do backend):", process.env.FACEBOOK_APP_ID); 
...
console.log("MONGODB_URI (Início):", process.env.MONGODB_URI ? `${String(process.env.MONGODB_URI).substring(0,15)}... (existe)`: 'NÃO CONFIGURADO');
