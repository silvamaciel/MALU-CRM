...
export const listarArquivosApi = async () => {
    try {
...
export const uploadArquivoApi = async (file, onUploadProgress) => {
    ...
    try {
        const response = await axiosInstance.post('/files/upload', formData, {
            ...
            onUploadProgress: onUploadProgress, // Passa a função de callback para o Axios
        });
        return response.data.data;
    } catch (error) {
